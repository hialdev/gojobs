<template> 
<div style="font-family:'Poppins', sans-serif; color:#4d4d4d; background-color: #f5f5f5; display: flex; align-items: start;">
        <!-- Sidebar -->
        <div style="background-color: #f5f5f5; padding: 35px; width: 25%; height: 100%;">
            <div>
                <img src="https://placehold.co/170" width="170" height="170" alt="Image Name Surname" style="display: block;margin: 10px auto; border-radius: 999px; object-fit: cover; border: 2px solid #cecece; padding: 5px;">
            </div>
            <ul style="padding:0px; list-style: none;">
                <li><h3>Biodata</h3></li>
                <li style="font-family:'Poppins', sans-serif; color:#4d4d4d; margin-bottom: 0.4em; display: flex; align-items: center; gap: 0.7em;">
                    <div>
            ...
            <ul style="padding:0px; list-style: none;">
                ...
                <li style="font-family:'Poppins', sans-serif; color:#4d4d4d; margin-bottom: 0.4em; display: flex; align-items: center; gap: 0.7em;">
                    ...
                    Lorem ipsum dolor sit amet consectetur adipisicing elit, Blok A no 52
                </li>
                <li style="font-family:'Poppins', sans-serif; color:#4d4d4d; margin-bottom: 0.4em; display: flex; align-items: center; gap: 0.7em;">
                    <div>
            ...
            <ul style="padding:0px; list-style: none;">
                ...
                <li style="font-family:'Poppins', sans-serif; color:#4d4d4d; margin-bottom: 0.4em; display: flex; align-items: center; gap: 0.7em;">
                    ...
                    <a href="https://instagram.com/username" style="text-decoration: none; color: #4d4d4d; display: block; color: #212121" target="_blank">username</a>
                </li>
                <li style="font-family:'Poppins', sans-serif; color:#4d4d4d; margin-bottom: 0.4em; display: flex; align-items: center; gap: 0.7em;">
                    <div>
                    ...
                    <a href="https://twitter.com/username" style="text-decoration: none; color: #4d4d4d; display: block; color: #212121" target="_blank">username</a>
                </li>
                <li style="font-family:'Poppins', sans-serif; color:#4d4d4d; margin-bottom: 0.4em; display: flex; align-items: center; gap: 0.7em;">
                    <div>
                    ...
                    <a href="https://facebook.com/username" style="text-decoration: none; color: #4d4d4d; display: block; color: #212121" target="_blank">username</a>
                </li>
                <li style="font-family:'Poppins', sans-serif; color:#4d4d4d; margin-bottom: 0.4em; display: flex; align-items: center; gap: 0.7em;">
                    <div>
                    ...
                    <a href="https://linkedin.com/in/username" style="text-decoration: none; color: #4d4d4d; display: block; color: #212121" target="_blank">username</a>
                </li>
            </ul>
        </div>
        <!-- Content -->
        <div style="background-color: #fff;width: 75%;">
            <div style="padding: 35px; border-bottom: 4px solid #f5f5f5;">
                <h1 style="margin: 0px;">Muhammad Nur Alif</h1>
                <div style="font-size: 19px; color: #adadad;">Sr. Software Engineer</div>
                <p style="">Developer dengan pengalaman lebih dari 5 tahun bekerja di sektor publik dan swasta.
                    Diplomatik, berkepribadian, dan mahir dalam mengelola situasi sensitif. Sangat terorganisir,
                    memiliki motivasi diri, dan mahir menggunakan komputer. Ingin meningkatkan nilai
                    kepuasan mahasiswa untuk Universitas Internasional. Gelar sarjana di bidang komunikasi.</p>
            </div>
            <div style="padding: 35px; border-bottom: 4px solid #f5f5f5;">
                ...
                <div style="margin-bottom: 1em;">
                    <div style="display: flex; align-items: center; justify-content: space-between;">
                        <div>
                            <h4 style="margin: 0px;">Web Design & Development Team Leader</h4>
                            <div style="">Infomedia Solusi Humanika</div>
                        </div>
                        <div style="font-size: 12px; color: #adadad;">21 May 2022 - 22 Sept 2023</div>
                    </div>
                    <div style="padding: 1em 0px ;padding-left: 1em; border-left: 2px solid #f0f0f0; font-size: 13px;">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vero quibusdam quam quas nostrum assumenda sint laboriosam adipisci incidunt modi sequi error, placeat doloribus similique possimus et at consequatur quae fugit?
                    </div>
                </div>
            </div>
            ...
            <div style="padding: 35px; border-bottom: 4px solid #f5f5f5;">
                ...
                <div style="margin-bottom: 1em;">
                    <div style="display: flex; margin-bottom: 0.7em; align-items: center; justify-content: space-between;">
                        <div>
                            <h4 style="margin: 0px;">Universitas Indonesia</h4>
                            <div style="display: flex; align-items: center; gap: 1em;"><span>S1</span> | <span>Depok</span></div>
                        </div>
                        <div style="font-size: 12px; color: #adadad;">21 May 2022 - 22 Sept 2023</div>
                    </div>
                    <div style="display: flex; grid-template-columns: 3; gap: 1em;">
            ...
            <div style="padding: 35px; border-bottom: 4px solid #f5f5f5;">
                ...
                <div style="margin-bottom: 1em;">
                    <div style="display: flex; margin-bottom: 0.7em; align-items: center; justify-content: space-between;">
                        <div>
                            <h4 style="margin: 0px;">Universitas Indonesia</h4>
                            <div style="display: flex; align-items: center; gap: 1em;">Posisi</div>
                        </div>
                        <div style="font-size: 12px; color: #adadad;">21 May 2022 - 22 Sept 2023</div>
                    </div>
                </div>
            ...
            <div style="padding: 35px; border-bottom: 4px solid #f5f5f5;">
                ...
                <div style="margin-bottom: 1em;">
                    <h4 style="margin: 0px; margin-bottom: 0.7em;">Inggriss</h4>
            ...
            <div style="padding: 35px; border-bottom: 4px solid #f5f5f5;">
                ...
                <div style="display: flex; align-items: center; flex-wrap: wrap; gap: 0.4em;">
                    <span style="padding: 4px 9px; font-size: 12px; border-radius: 10px; border: 1px solid #4d4d4d;">Skill One</span>
                    <span style="padding: 4px 9px; font-size: 12px; border-radius: 10px; border: 1px solid #4d4d4d;">Skill Two</span>
                    <span style="padding: 4px 9px; font-size: 12px; border-radius: 10px; border: 1px solid #4d4d4d;">Skill Three</span>
                    <span style="padding: 4px 9px; font-size: 12px; border-radius: 10px; border: 1px solid #4d4d4d;">Skill Four</span>
                </div>
            </div>
        </div>
    </div>       
