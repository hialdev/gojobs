            ...
            <div class="container mx-auto h-screen px-5">
                <div class="grid grid-cols-12 items-center h-full">
                    <div class="col-span-12 lg:col-span-6">
                        <h1 class="text-white text-7xl mt-5 lg:mt-0 lg:text-8xl font-semibold">Yuk Lamar di GoJobs! <br /><span class="font-normal text-4xl lg:text-5xl">#Teman Cari Kerja</span></h1>
                    </div>
                    <div class="col-span-12 lg:col-span-6">
